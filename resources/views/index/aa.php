                                ...
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="m-b-30">
                                            ...
                                            <div class="p-t-20">
                                                <h5 class="p-b-5">
                                                    <a href="http://127.0.0.1:8000/{{$listTinBlockChain[0]->tinId}}" class="f1-m-3 cl2 hov-cl10 trans-03">
                                                ...
                                                <span class="cl8">
                                                    <a href="#" class="f1-s-4 cl8 hov-cl10 trans-03">
                                                        by {{$listTinBlockChain[0]->tk_hoTen}}
                                                    </a>
                                                    ...
                                                    <span class="f1-s-3">
                                                        {{$listTinBlockChain[0]->tin_ngayDang}}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{$listTinBlockChain[$i]->tinId}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                            ...
                                            <div class="size-w-2">
                                                ...
                                                <span class="cl8">
                                                    ...
                                                    <span class="f1-s-3">
                                                        {{$listTinBlockChain[$i]->tin_ngayDang}}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
