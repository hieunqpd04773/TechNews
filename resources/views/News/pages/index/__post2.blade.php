                            ...
                            <div class="tab-pane fade show active" id="tab1-1" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <!-- Item post -->	
                                        <div class="m-b-30">
                                            <a href="tin/{{$allTin[0]->tinId}}" class="wrap-pic-w hov1 trans-03">
                                                <img src="images/tin/{{$allTin[0]->tin_anhBia}}" alt="IMG">
                                            </a>

                                            <div class="p-t-20">
                                                <h5 class="p-b-5">
                                                    <a href="http://127.0.0.1:8000/{{$allTin[0]->tinId}}" class="f1-m-3 cl2 hov-cl10 trans-03">
                                                        {{$allTin[0]->tin_tieuDe}} 
                                                    </a>
                                                </h5>
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        <!-- Item post -->
                                        @for($i=1;$i<count($allTin);$i++)	
                                        <div class="flex-wr-sb-s m-b-30">
                                            <a href="{{$allTin[$i]->tinId}}" class="size-w-1 wrap-pic-w hov1 trans-03">
                                                <img src="images/tin/{{$allTin[$i]->tin_anhBia}}" alt="IMG">
                                            </a>
