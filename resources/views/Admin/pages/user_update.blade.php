      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="{{route('updateUser')}}" class="forms-sample">
              @csrf
              <div class="form-group">
                <label for="exampleInputName1">Họ Tên</label>
                <input type="hidden" value="{{$user->id}}" name="id">
                <input type="text" name="hoTen" class="form-control" value="{{$user->name}}" id="exampleInputName1" placeholder="Nhập họ tên">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail3">Địa Chỉ Email</label>
                <input type="email" value="{{$user->email}}" name="email" class="form-control" id="exampleInputEmail3" placeholder="Email">
              </div>  
              <div class="form-group">
                <label for="exampleInputEmail3">Hình Ảnh</label>
                <input type="text" value="{{$user->hinhAnh}}" class="form-control" name="hinhAnh" id="exampleInputEmail3" placeholder="Email">
              </div>            
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleSelectGender">Trạng Thái</label>
                  <select class="form-control" name="trangThai" id="exampleSelectGender">
                    ...
                    <option value="0" selected>Hủy Kích Hoạt</option>
                    @endif
                  </select>
              </div>
              <div class="form-group">
